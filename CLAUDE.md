# Nano Banana - Image Generation Instructions

This file contains specific instructions for working with the Nano Banana extension for image generation, editing, and restoration via the MCP server tools.
